<script setup>
import { importantInfo_320, mockData_300 } from "@fakedb";
...
const activeElement = computed(() => {
  if (currentActiveElement.value)
    return mockData_300[currentActiveElement.value - 1];
  return null;
});
        ...
        <div class="d-flex justify-space-between">
          <div>
            ...
            >
              ...
              <p
                class="mt-2"
                style="padding-inline-end: 10px; height: 81px"
